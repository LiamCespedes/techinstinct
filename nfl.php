...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="./nfl.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">NFL Stats</a>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">NFL Statistics</h1>
  <p class="w3-xlarge">Standings, player rankings, and more...</p>
  
  <img src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a2/National_Football_League_logo.svg/1200px-National_Football_League_logo.svg.png" width="150px" class="w3-padding-large w3-large w3-margin-top" alt="NFL Logo">
</header>
